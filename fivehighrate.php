...
include 'config.php';
$array = array(); //record order high rate;

$sql = "SELECT product_id, AVG(rating) AS average FROM comments GROUP BY
                 product_id ORDER BY average DESC LIMIT 0, 5";
...
while($row = mysqli_fetch_assoc($result))
{
    ...
    $sql_product = "SELECT product_name From products WHERE product_id = $productId";
    ...
    echo '<br>';
    echo "Product :".$row_product['product_name']."</a>"."<br><br>";
}
